...
<div class="flex justify-center items-center w-full">
    <label id='dropzone' for="add-image" class="flex flex-col justify-center items-center w-full h-64 bg-slate-100 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer  hover:bg-gray-100">
